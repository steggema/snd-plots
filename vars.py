...
vars = [
    ...
    Var('n_hits_scifi', lambda h: ak.count(h.det[h.det == 1], axis=1), 'Number of scifi hits'),
    ...
    Var('n_hits_veto', lambda h: ak.count(h.det[(h.det == 1) & (h.strip_z < 290.)], axis=1), 'Number of veto hits'),
    ...
    Var('n_hits_scifi_1', lambda h: ak.count(h.det[(h.det == 1) & (h.strip_z > 295.) & (h.strip_z < 305.)], axis=1), 'Number of scifi_1 hits'),
    Var('n_hits_scifi_2', lambda h: ak.count(h.det[(h.det == 1) & (h.strip_z > 310.) & (h.strip_z < 320.)], axis=1), 'Number of scifi_2 hits'),
    Var('n_hits_scifi_3', lambda h: ak.count(h.det[(h.det == 1) & (h.strip_z > 320.) & (h.strip_z < 330.)], axis=1), 'Number of scifi_3 hits'),
    Var('n_hits_scifi_4', lambda h: ak.count(h.det[(h.det == 1) & (h.strip_z > 335.) & (h.strip_z < 345.)], axis=1), 'Number of scifi_4 hits'),
    Var('n_hits_scifi_5', lambda h: ak.count(h.det[(h.det == 1) & (h.strip_z > 350.) & (h.strip_z < 360.)], axis=1), 'Number of scifi_5 hits'),
    ...
    Var('n_hits_scifi_vertical', lambda h: ak.count(h.det[(h.det == 1) & (h.vertical == 1)], axis=1), 'Number of vertical SciFi hits'),
    ...
    Var('n_hits_scifi_horizontal', lambda h: ak.count(h.det[(h.det == 1) & (h.vertical == 0)], axis=1), 'Number of horizontal SciFi hits'),
